...
const result: PossibleTypesResultData = {
  possibleTypes: {
    Source: ["DatabaseSource", "VirtualSource"],
  },
};
...
export type SourceConnectionQuery = {
  __typename?: "Query";
  sourceConnection: {
    __typename?: "SourceConnection";
...
export const UpdateClipDocument = gql`
  ...
  ${ClipFragmentDoc}
`;
export type UpdateClipMutationFn = Apollo.MutationFunction<
  UpdateClipMutation,
 ...
 * });
 */
export function useSourceConnectionQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SourceConnectionQuery, SourceConnectionQueryVariables>(
    SourceConnectionDocument,
    options
  );
}
export function useSourceConnectionLazyQuery(
  ...
  return Apollo.useLazyQuery<
    SourceConnectionQuery,
    SourceConnectionQueryVariables
  >(SourceConnectionDocument, options);
}
export type SourceConnectionQueryHookResult = ReturnType<
  typeof useSourceConnectionQuery
>;
export type SourceConnectionLazyQueryHookResult = ReturnType<
  typeof useSourceConnectionLazyQuery
>;
export type SourceConnectionQueryResult = Apollo.QueryResult<
  SourceConnectionQuery,
  SourceConnectionQueryVariables
>;
